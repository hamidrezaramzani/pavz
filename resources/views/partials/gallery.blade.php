<div class="col-12 gallery">
    ...
    <div class="row d-none d-md-flex">
        ...
        <div class="col-6 p-1 gallery-item position-relative">
            ...
            <img src="{{ asset("user/".$folder . '/' . $images[0]->url) }}" width="100%" height="550" alt="image">

        </div>
        <div class="col-3 p-1 gallery-item">
            <img src="{{ asset("user/".$folder . '/' . $images[1]->url) }}" width="100%" height="275" alt="image">
            <img src="{{ asset("user/".$folder . '/' . $images[2]->url) }}" width="100%" height="275" alt="image">

        </div>
        <div class="col-3 p-1 gallery-item">
            <img src="{{ asset("user/".$folder . '/' . $images[3]->url) }}" width="100%" height="275" alt="image">
            <img src="{{ asset("user/".$folder . '/' . $images[4]->url) }}" width="100%" height="275" alt="image">
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="gallery-slider">
                ...
                <div class="gallery-item-responsive">
                    <img src="{{ asset("user/" . $folder . '/' . $item->url) }}" alt="Villa Camera">
                </div>    
                @endforeach
