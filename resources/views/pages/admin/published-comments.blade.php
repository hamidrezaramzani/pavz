                    ...
                    <table class="table text-center table-striped table-hover">
                        ...
                        <tbody>
                            @if (count($comments))
                                ...
                                @endforeach
                            @else
                                <td colspan="6" class="text-center text-danger is">نظر قبول شده ای وجود ندارد</td>
                            @endif
                        </tbody>
                    </table>
                </div>
