...
@section('content')
    @include('pages.slideshow' , ["images" => $data->pictures()->get() , "folder" => "shop_pictures"])
    @include('partials.navbar')
    @include('partials.home.header')
    <div class="container my-5">
        <div class="row justify-content-center villa-content">
            @include('partials.gallery' , ["images" => $data->pictures()->get() , "folder" => "shop_pictures"])
            <div class="col-12 col-md-8">
                @include("pages.shop.sections.main")
                @include("pages.shop.sections.home")
                @include("pages.shop.sections.scores")
                @include("pages.shop.sections.possibilities")
                @include("pages.shop.sections.prices")
                @include("pages.shop.sections.address")
            </div>
